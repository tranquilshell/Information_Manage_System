...
public class EditPasswordFrm extends JInternalFrame {
	...
	protected void submitEdit(ActionEvent e) {
		...
		if("系统管理员".equals(MainFrm.userType.getName())){
			...
			JOptionPane.showMessageDialog(this, adminObj.editPassword(adminTmp, newPassword));
			adminObj.closeObj();
			return;
		}
		if("学生".equals(MainFrm.userType.getName())){
			...
			JOptionPane.showMessageDialog(this, studentObj.editPassword(studentTmp, newPassword));
			studentObj.closeObj();
			return;
		}
		if("教师".equals(MainFrm.userType.getName())){
			...
			JOptionPane.showMessageDialog(this, teacherObj.editPassword(teacherTmp, newPassword));
			teacherObj.closeObj();
			return;
		}
